...
data.path <- str_c("D:/Boundary_LiDAR/data/")
...
aoi <- sf::st_read("D:/Boundary_LiDAR/AOI/BDY_R_AOI.shp")
...
download_lidarbc(aoi.index = aoi.index, data.path = data.path, cores = 12L)

normalize_lidarbc(data.path = data.path, cores = 12L)

create_DEM(data.path = data.path, cores = 6L)
merge_DEM()
